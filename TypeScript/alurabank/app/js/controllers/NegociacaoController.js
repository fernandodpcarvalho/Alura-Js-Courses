    ...
    return {
        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                adiciona() {
                    let dataInput = $(this._inputData).val();
                    let data = new Date(dataInput.replace(/-/g, ','));
                    if (!this._ehDiaUtil(data)) {
                        this._mensagemView.update('Somente negociações em dias úteis, por favor!');
                        return;
                    }
                    let quantidadeInput = $(this._inputQuantidade).val();
                    let valorInput = $(this._inputValor).val();
                    const negociacao = new index_2.Negociacao(data, parseInt(quantidadeInput), parseFloat(valorInput));
