    ...
    args.forEach(arg => {
        ...
        if (arg.module) {
            ...
            if (varName) {
                ...
                codegen.addStaticVar(varName, builder.logicalExpression(builder.memberExpression(moduleName, builder.identifier("default")), "||", moduleName));
            } else {
            ...
            codegen.addStaticVar(varName, builder.memberExpression(modIdentifier, builder.identifier(arg.value.property)));
        }
    });
